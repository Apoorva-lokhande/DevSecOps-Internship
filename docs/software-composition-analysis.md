...
The complete report generated by NodeJsScan can be found [here](https://github.com/Apoorva-lokhande/DevSecOps-internship/blob/master/reports/depedency-check-report.json).